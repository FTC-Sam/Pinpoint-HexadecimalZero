...
public class Drivetrain {
    ...
    public void drive() {
        ...
        double rx = gamepad1.right_stick_x * (!crane.horiSlides.isReset()?.35:1) * (crane.vertiSlides.getCurrentPos() > 2000?.9:1);
        telemetry.addData("Slowdown", !crane.horiSlides.isReset());
        telemetry.update();
