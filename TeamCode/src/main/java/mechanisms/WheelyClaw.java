...
public class WheelyClaw {
    ...
    public WheelyClaw(HardwareMap hardwareMap, Telemetry telemetry) {
    ...
    public WheelyClaw(HardwareMap hardwareMap, Telemetry telemetry, boolean t) {
        this.telemetry = telemetry;
